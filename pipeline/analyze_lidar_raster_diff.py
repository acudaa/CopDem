...
<div class="wrap">
  <header>
    ...
    <p>Whole-country per-cell comparison, 10&#160;m grid (LiDAR's native resolution &#8212; CopDEM
       ...
       Raster build method and the instructed (not independently verified) LiDAR vertical-datum
       assumption: <a href="../docs/lidar_comparison.md">docs/lidar_comparison.md</a>.</p>
  </header>
